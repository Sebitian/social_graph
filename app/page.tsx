  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background bg-grid">
      ...
      <section className="relative z-10 mx-auto flex min-h-screen max-w-5xl flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="max-w-3xl text-5xl font-bold leading-tight tracking-tight text-white sm:text-7xl">
        ...
        <div className="grid gap-4 sm:grid-cols-3">
          {features.map((f) => {
            ...
            return (
              ...
              >
                <div className="mb-4 inline-flex rounded-xl bg-ig-gradient p-2.5">
